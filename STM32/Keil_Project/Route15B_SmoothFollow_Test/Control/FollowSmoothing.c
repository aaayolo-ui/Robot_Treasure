...
/* Independent experiment switches. Values are conservative starting points,
 * not hardware-verified tuning results. All speeds use RPM x10. */
...
#define SMOOTH_STEER_STEP_RPM_X10    20L
#define SMOOTH_CURVE_START_ERROR    100L
#define SMOOTH_CURVE_FULL_ERROR     300L
#define SMOOTH_CURVE_MIN_BASE_X10   300L

...
#define CHASSIS_SPEED_STALL_TARGET_RPM_X10 100L
...
void ChassisSpeedControl_Init(void)
{
  ...
  WheelSpeedPi_SetGains(&controllers[CHASSIS_WHEEL_FRONT_LEFT],
                        WHEEL_FL_B_KP_X100, WHEEL_FL_B_KI_X100);
  WheelSpeedPi_SetGains(&controllers[CHASSIS_WHEEL_FRONT_RIGHT],
                        WHEEL_FR_A_KP_X100, WHEEL_FR_A_KI_X100);
  WheelSpeedPi_SetGains(&controllers[CHASSIS_WHEEL_REAR_LEFT],
                        WHEEL_RL_D_KP_X100, WHEEL_RL_D_KI_X100);
  WheelSpeedPi_SetGains(&controllers[CHASSIS_WHEEL_REAR_RIGHT],
                        WHEEL_RR_C_KP_X100, WHEEL_RR_C_KI_X100);
...
void ChassisSpeedControl_Update(uint32_t elapsed_ms)
{
  ...
  for (wheel = CHASSIS_WHEEL_FRONT_LEFT; wheel < CHASSIS_WHEEL_COUNT; wheel++)
  {
    ...
    if ((ChassisSpeedControl_Absolute(WheelSpeedPi_GetTarget(&controllers[wheel])) >=
        ...
        (ChassisSpeedControl_Absolute(output) >= 160LL) &&
